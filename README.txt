...
This project cannot be used without at least two users, so please keep that in mind.
Note: when entering a code, you must click the submit button rather than pressing enter
Yjs was used for multi device communication and server side authentication. React was used to deploy the webpage and add interactive elements
