                ...
                <div class = "results">
                    ...
                    <div class = "team2">
                        ...
                        <div class = "inBetween">
                            ...
                            <div class ="right"><h3>Bans</h3></div>
                            <div class = "left">
                                <h3 class="waitWarning">Please wait, blue side is picking.</h3>
                            </div>
            ...
            <div>
                <div class = "results">
                    <div class = "team1">
                        ...
                        <div class = "inBetween">
                            <div class = "right">
                                <h3 class="waitWarning">Please wait, red side is picking.</h3>
                            </div>
                            <div class ="left"><h3>Bans</h3></div>
